...
void VulkanEngine::run()
{
    ...
    while (!bQuit)
    {
        ...
        while (SDL_PollEvent(&e) != 0)
        {
            ...
            if (e.type == SDL_KEYDOWN) { fmt::print("Key down: {}\n", SDL_GetKeyName(e.key.keysym.sym)); }
...
void VulkanEngine::init_mesh_pipeline()
{
    ...
    if (!vkutil::load_shader_module("../shaders/texImage.frag.spv", _device, &triangleFragShader)) {
    ...
    if (!vkutil::load_shader_module("../shaders/coloredTriangleMesh.vert.spv", _device, &triangleVertexShader)) {
